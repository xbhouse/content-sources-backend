...
type: pull_request
number: 1301
title: "Build: Bump js-yaml from 4.1.0 to 4.1.1"
state: closed
author: dependabot
created: 2025-11-15T11:48:33Z
updated: 2025-11-17T09:39:03Z
closed: 2025-11-17T09:39:02Z
base_branch: main
head_branch: dependabot/npm_and_yarn/js-yaml-4.1.1
labels: ["dependencies", "javascript"]
url: https://github.com/content-services/content-sources-backend/pull/1301
---

# Pull Request #1301: Build: Bump js-yaml from 4.1.0 to 4.1.1

**Author**: @dependabot
**Created**: November 15, 2025 at 11:48 AM UTC
**Status**: Closed
**Labels**: `dependencies`, `javascript`
**Base**: `main` ← **Head**: `dependabot/npm_and_yarn/js-yaml-4.1.1`
...
### Comment by @swadeley on November 17, 2025 at 09:33 AM UTC

@dependabot rebase

### Comment by @dependabot on November 17, 2025 at 09:39 AM UTC

Looks like js-yaml is up-to-date now, so this is no longer needed.

---

*Archived from: https://github.com/content-services/content-sources-backend/pull/1301*
