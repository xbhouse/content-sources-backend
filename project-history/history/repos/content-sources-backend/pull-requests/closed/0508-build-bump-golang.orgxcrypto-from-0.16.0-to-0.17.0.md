...
type: pull_request
number: 508
title: "Build: Bump golang.org/x/crypto from 0.16.0 to 0.17.0"
state: closed
author: dependabot
created: 2023-12-19T00:07:08Z
updated: 2023-12-19T16:33:07Z
closed: 2023-12-19T16:33:05Z
base_branch: main
head_branch: dependabot/go_modules/golang.org/x/crypto-0.17.0
labels: ["dependencies"]
url: https://github.com/content-services/content-sources-backend/pull/508
---

# Pull Request #508: Build: Bump golang.org/x/crypto from 0.16.0 to 0.17.0

**Author**: @dependabot
**Created**: December 19, 2023 at 12:07 AM UTC
**Status**: Closed
**Labels**: `dependencies`
**Base**: `main` ← **Head**: `dependabot/go_modules/golang.org/x/crypto-0.17.0`
...
### Comment by @app-sre-bot on December 19, 2023 at 12:09 AM UTC

Can one of the admins verify this patch?

### Comment by @dependabot on December 19, 2023 at 04:33 PM UTC

Looks like golang.org/x/crypto is up-to-date now, so this is no longer needed.

---

*Archived from: https://github.com/content-services/content-sources-backend/pull/508*
