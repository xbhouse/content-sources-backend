...
state: closed
author: dependabot
created: 2025-01-27T18:35:34Z
updated: 2025-01-30T14:50:19Z
closed: 2025-01-30T14:50:17Z
base_branch: master
head_branch: dependabot/npm_and_yarn/lint-6ade59852b
labels: ["dependencies", "major"]
url: https://github.com/RedHatInsights/patchman-ui/pull/1260
---

# Pull Request #1260: chore(deps): bump the lint group across 1 directory with 5 updates

**Author**: @dependabot
**Created**: January 27, 2025 at 06:35 PM UTC
**Status**: Closed
**Labels**: `dependencies`, `major`
**Base**: `master` ← **Head**: `dependabot/npm_and_yarn/lint-6ade59852b`
...
| Package | From | To |
| --- | --- | --- |
| [eslint](https://github.com/eslint/eslint) | `7.32.0` | `9.19.0` |
...
| [stylelint-scss](https://github.com/stylelint-scss/stylelint-scss) | `6.8.0` | `6.10.1` |


Updates `eslint` from 7.32.0 to 9.19.0
<details>
...
<li>Additional commits viewable in <a href="https://github.com/eslint/eslint/compare/v7.32.0...v9.19.0">compare view</a></li>
</ul>
</details>
<details>
...
<li>Fixed: <code>selector-pseudo-class-no-unknown</code> false positives for <code>:has-slotted</code...
...
### Comment by @dependabot on January 30, 2025 at 02:50 PM UTC

Superseded by #1272.

---

*Archived from: https://github.com/RedHatInsights/patchman-ui/pull/1260*
