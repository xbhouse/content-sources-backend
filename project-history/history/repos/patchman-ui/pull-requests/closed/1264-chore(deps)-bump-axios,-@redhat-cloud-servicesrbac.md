...
state: closed
author: dependabot
created: 2025-01-28T11:59:26Z
updated: 2025-01-30T14:49:53Z
closed: 2025-01-30T14:49:51Z
base_branch: master
head_branch: dependabot/npm_and_yarn/multi-f43a05fecb
labels: ["dependencies", "major"]
url: https://github.com/RedHatInsights/patchman-ui/pull/1264
---

# Pull Request #1264: chore(deps): bump axios, @redhat-cloud-services/rbac-client, @redhat-cloud-services/frontend-components-remediations and @redhat-cloud-services/host-inventory-client

**Author**: @dependabot
**Created**: January 28, 2025 at 11:59 AM UTC
**Status**: Closed
**Labels**: `dependencies`, `major`
**Base**: `master` ← **Head**: `dependabot/npm_and_yarn/multi-f43a05fecb`
...
Updates `axios` from 1.7.7 to 1.7.7
<details>
...
<ul>
<li>See full diff in <a href="https://github.com/axios/axios/compare/v1.7.7...v1.7.7">compare view</a></li>
</ul>
</details>
<br />
...
*Archived from: https://github.com/RedHatInsights/patchman-ui/pull/1264*
